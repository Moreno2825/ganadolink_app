...
class CustomListviewSearch extends StatefulWidget {
  final double height;
  ...
  @override
  State<CustomListviewSearch> createState() => _CustomListviewSearchState();
}

class _CustomListviewSearchState extends State<CustomListviewSearch> {
  ///! ---------------------------------------------------------------------------------------------
  ///! EDITING CONTROLLER
  ///! ---------------------------------------------------------------------------------------------
  ...
  List<Diet> getFilteredDiets() {
    if (searchQuery.isEmpty) {
      return widget.diets;
    }
    return widget.diets.where((diet) {
      return diet.id.toLowerCase().contains(searchQuery.toLowerCase()) ||
          diet.ganado!.siniiga.toLowerCase().contains(searchQuery.toLowerCase()) ||
          diet.ganado!.color.toLowerCase().contains(searchQuery.toLowerCase()) ||
          diet.ganado!.peso.toString().contains(searchQuery);
    }).toList();
  }
        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: const InputDecoration(
              labelText: 'Buscar',
              hintText: 'Buscar por ID, Arete, Color, Peso...',
        ...
        Expanded(
          child: Container(
            ...
            child: ListView.builder(
              itemCount: getFilteredDiets().length,
              itemBuilder: (context, i) {
                final diet = getFilteredDiets()[i];
                return Dismissible(
